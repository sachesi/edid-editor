...
rcode EDID_cl::CreateGroup(group_template which, u8_t displayid_version,
   ...
   //VESA DMT 640x480 at 59.94 Hz: 25.18 MHz, 16/96/48 px, 10/2/33 lines
   static const u8_t timing[] = {
      0xD6, 0x09, 0x80, 0xA0, 0x20, 0xE0, 0x2D, 0x10, 0x10,
      0x60, 0xA2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18,
   };
   u8_t displayid[] = {
